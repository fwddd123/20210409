...
class T02_ChargeOrder_Paytype_H_Createtable(Bybo_base):
    def __init__(self):
        super().__init__()
    ...
    def creat_table(self):
        ...
        logger.info("T02_ChargeOrder_Paytype_H_Createtable.py begintime=" + beginTime)
        ...
        try:
            ...
            sql_T02_Appointment_H = '''
                         CREATE TABLE IF NOT EXISTS T02_ChargeOrder_Paytype_H
    (
            ChargeOrderId varchar(50) NOT NULL    DEFAULT ''COMMENT'收费单编号',
            PayType varchar(50) NOT NULL    DEFAULT ''COMMENT'收费方式',
            ActualPrice decimal(18,2) NOT NULL    DEFAULT '0'COMMENT'收费金额',
  ...
  DEFAULT CHARSET = utf8;
            ...
            CREATE TABLE IF NOT EXISTS T02_ChargeOrder_Paytype_H_Tmp
(
           ChargeOrderId varchar(50) NOT NULL    DEFAULT ''COMMENT'收费单编号',
            PayType varchar(50) NOT NULL    DEFAULT ''COMMENT'收费方式',
            ActualPrice decimal(18,2) NOT NULL    DEFAULT '0'COMMENT'收费金额',
  ...
  DEFAULT CHARSET = utf8;
            ...
            sql_T02_Appointment_H_Log = '''
                        CREATE TABLE IF NOT EXISTS T02_ChargeOrder_Paytype_H_Log
            (
           ...
           ChargeOrderId varchar(50) NOT NULL    DEFAULT ''COMMENT'收费单编号',
            ...
            self.addMessage(conn, 'T02_ChargeOrder_Paytype_H_Createtable.py', jobMsg, jobSt, starttime.strftime(stF),
...
if __name__ == '__main__':
    eg = T02_ChargeOrder_Paytype_H_Createtable()
    logger = eg.logger
    logger.info("任务开始")
    stF = "%Y-%m-%d %H:%M:%S"
    # 默认为前一天
