...
class Bybo_T01PartiRelation_Createtable(Bybo_base):
    def __init__(self):
        super().__init__()
    ...
    def creat_table(self):
        ...
        logger.info("Bybo_T01_PartiRelation_Createtable.py begintime=" + beginTime)

        try:
            # T01_Patient_H DW目标表
            sql_T01_PartiRelation_H = '''
                         CREATE TABLE IF NOT EXISTS T01_PartiRelation_H
(
    PatientID          varchar(50) NOT NULL DEFAULT '' COMMENT '患者加区域生成编号',
    RelationPartiId    varchar(50) NOT NULL DEFAULT '' COMMENT '网电咨询师加区域生成编号',
    Region             varchar(10) NOT NULL DEFAULT '' COMMENT '源系统区域代码',
    Id                 varchar(50) NOT NULL DEFAULT '' COMMENT '源系统患者编号',
    OnlineConsultantId varchar(50) NOT NULL DEFAULT '' COMMENT '源系统网电咨询师编号',
  ...
  DEFAULT CHARSET = utf8;
                       '''
            cur.execute(sql_T01_PartiRelation_H)

            # T01_Patient_H T01_Patient_H 临时表
            sql_T01_PartiRelation_H_Tmp = '''
            CREATE TABLE IF NOT EXISTS T01_PartiRelation_H_Tmp
(
    PatientID          varchar(50) NOT NULL DEFAULT '' COMMENT '患者加区域生成编号',
    RelationPartiId    varchar(50) NOT NULL DEFAULT '' COMMENT '网电咨询师加区域生成编号',
    Region             varchar(10) NOT NULL DEFAULT '' COMMENT '源系统区域代码',
  ...
  DEFAULT CHARSET = utf8;
            '''
            cur.execute(sql_T01_PartiRelation_H_Tmp)

            # T01_Patient_H T01_Patient_H log表
            sql_T01_PartiRelation_H_Log = '''
                        CREATE TABLE IF NOT EXISTS T01_PartiRelation_H_Log
            (
    PatientID          varchar(50) NOT NULL DEFAULT '' COMMENT '患者加区域生成编号',
    RelationPartiId    varchar(50) NOT NULL DEFAULT '' COMMENT '网电咨询师加区域生成编号',
    Region             varchar(10) NOT NULL DEFAULT '' COMMENT '源系统区域代码',
    ...
    SourceName varchar(50) NOT NULL DEFAULT '' COMMENT '数据源'
              ...
              DEFAULT CHARSET = utf8;
                        '''
            cur.execute(sql_T01_PartiRelation_H_Log)
            ...
            self.addMessage(conn, 'Bybo_T01_PartiRelation_Createtable.py', jobMsg, jobSt, starttime.strftime(stF),
...
if __name__ == '__main__':
    eg = Bybo_T01PartiRelation_Createtable()
    logger = eg.logger
    logger.info("任务开始")
    stF = "%Y-%m-%d %H:%M:%S"
    # 默认为前一天
