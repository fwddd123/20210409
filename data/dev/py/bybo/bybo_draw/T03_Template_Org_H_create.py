...
class T03_Template_Org_H_Createtable(Bybo_base):
    def __init__(self):
        super().__init__()
    ...
    def creat_table(self):
        ...
        logger.info("T03_Template_Org_H.py begintime=" + beginTime)
        ...
        try:
            # T01_Patient_H DW目标表
            T03_Template_Org_H = '''
                         CREATE TABLE IF NOT EXISTS T03_Template_Org_H
    (
            TemplateId varchar(50) NOT NULL    DEFAULT ''COMMENT'卡券模板编号',
            OfficeId varchar(50) NOT NULL    DEFAULT ''COMMENT'卡券适用组织编号',
            IsAvailability varchar(10) NOT NULL    DEFAULT ''COMMENT'有效标识',
            Platform varchar(10) NOT NULL    DEFAULT '0'COMMENT'平台代码',
  ...
  DEFAULT CHARSET = utf8;
                       '''
            cur.execute(T03_Template_Org_H)



            # T01_Patient_H T01_Patient_H 临时表
            T03_Template_Org_H_Tmp = '''
            CREATE TABLE IF NOT EXISTS T03_Template_Org_H_Tmp
(
            TemplateId varchar(50) NOT NULL    DEFAULT ''COMMENT'卡券模板编号',
            OfficeId varchar(50) NOT NULL    DEFAULT ''COMMENT'卡券适用组织编号',
            IsAvailability varchar(10) NOT NULL    DEFAULT ''COMMENT'有效标识',
  ...
  DEFAULT CHARSET = utf8;
            '''
            cur.execute(T03_Template_Org_H_Tmp)

            # T01_Patient_H T01_Patient_H log表
            T03_Template_Org_H_Log = '''
                        CREATE TABLE IF NOT EXISTS T03_Template_Org_H_Log
            (
            TemplateId varchar(50) NOT NULL    DEFAULT ''COMMENT'卡券模板编号',
            OfficeId varchar(50) NOT NULL    DEFAULT ''COMMENT'卡券适用组织编号',
            IsAvailability varchar(10) NOT NULL    DEFAULT ''COMMENT'有效标识',
            ...
            SourceName varchar(50) NOT NULL DEFAULT '' COMMENT '数据源'
              ...
              DEFAULT CHARSET = utf8;
                        '''
            cur.execute(T03_Template_Org_H_Log)
            ...
            self.addMessage(conn, 'T03_Template_Org_H.py', jobMsg, jobSt, starttime.strftime(stF),
...
if __name__ == '__main__':
    eg = T03_Template_Org_H_Createtable()
    logger = eg.logger
    logger.info("任务开始")
    stF = "%Y-%m-%d %H:%M:%S"
    # 默认为前一天
