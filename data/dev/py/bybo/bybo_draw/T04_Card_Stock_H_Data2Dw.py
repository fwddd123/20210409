...
class T04_Card_Stock_H_Data2Dw(Bybo_base):
    def __init__(self):
        super().__init__()
    ...
    def Draw_data(self,end_date,begin_date):
        ...
        try:
            ...
            sql2Tmp = '''
                    ...
                    select 
                    ifnull(a.id,'') as StockId
                    ,ifnull(a.template_id,'')  as TemplateId
                    ,ifnull(a.settlement_org_id,'')  as SettlementOrgId
                    ,ifnull(a.stock_mode,'')  as StockType
                    ,ifnull(a.platform,'') as PlatForm
                    ,ifnull(a.is_enable,'')  as IsEnable
                    ,ifnull(a.is_availability,'')  as IsAvailability
                    ,ifnull(a.stock_available_number,'1')  as StockAvailableNumber
                    ,ifnull(a.stock_total,'1')  as StockTotalAmount
                    ,ifnull(a.increase_number,'1')  as IncreaseAmount,
                    ...
                    md5(a.id)                     as Contrast_Id,
                    'bbkq_ods_card.stock'          as SourceName
                    from %s.stock a
                    where 
...
if __name__ == '__main__':
    ...
    try:
        ...
        F_or_N = eg.get_rowcount('T04_Card_Stock_H')
        print(F_or_N)
        if F_or_N > 0:
