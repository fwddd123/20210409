...
import datetime
import traceback
from bbkq_dwT98_Bybo_Cus_Treat_createtable import *
...
class ByBo_test(Bybo_base):
    ...
    def __init__(self):
        ...
        # self.begin_date='1900-01-01 00:00:00'
        self.begin_date = (datetime.datetime(yesterday.year, yesterday.month, yesterday.day, 0, 0, 0)).strftime(stF)
        self.end_date = (datetime.datetime(yesterday.year, yesterday.month, yesterday.day, 23, 59, 59)).strftime(stF)
    ...
    def log_info(self,order_name,order_table):
        ...
        try:
            ...
            logger.info(self.order_name + "结束 endtime=" + endtime.strftime(stF)+",总用时"+str(sub)+"秒")
...
if __name__ == '__main__':
    ...
    h=ByBo_test()
    h.log_info('bbkq_dw.T98_Bybo_Cus_Treat',order_table_Patient)
