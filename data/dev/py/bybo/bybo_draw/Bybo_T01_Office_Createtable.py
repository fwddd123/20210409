...
class Bo_T01_Office_Createtable(Bybo_base):
    def __init__(self):
        super().__init__()
    ...
    def creat_table(self):
        ...
        logger.info("Bybo_T01_Office_Createtable.py begintime=" + beginTime)
        Target_Dm = self.get_property_value('Target_Dm')

        try:
            # T01_Patient_H DW目标表
            sql = '''
            CREATE TABLE IF NOT EXISTS T01_Office_H
(
    OFFICEID         varchar(50)    NOT NULL    DEFAULT '' COMMENT '门店编码',
    OFFICE_NAME              varchar(200)    NOT NULL    DEFAULT '' COMMENT '门店名称',
    OFFICE_ABBREVIATION               varchar(200)     NOT NULL   DEFAULT '' COMMENT '门店名称缩写',
    CITY             varchar(200)    NOT NULL    DEFAULT '' COMMENT '城市',
    DEPT_UUID        varchar(200)      NOT NULL   DEFAULT '' COMMENT '事业部编码',
    DEPT_NAME      varchar(200)  NOT NULL   DEFAULT '' COMMENT '事业部名称',
    DEPT_ABBREVIATION       varchar(200)    NOT NULL    DEFAULT '' COMMENT '事业部名称缩写',
    AREA  varchar(200)    NOT NULL    DEFAULT '' COMMENT '大区',
    DEPT_LEVE        varchar(200)    NOT NULL    DEFAULT '' COMMENT '事业部层级',
    Id     varchar(50)    NOT NULL    DEFAULT '' COMMENT '源系统门店编码',
    REGION       varchar(10)     NOT NULL   DEFAULT '' COMMENT '源系统区域代码',
    CODE                varchar(50)      NOT NULL   DEFAULT '' COMMENT '门店财务编码',
    SUBCOMPANY varchar(200)     NOT NULL    DEFAULT '' COMMENT '人寿子公司',
  ...
  DEFAULT CHARSET = utf8
            ...
            sql = '''
            CREATE TABLE IF NOT EXISTS T01_Office_H_Tmp
(
    OFFICEID         varchar(50)    NOT NULL    DEFAULT '' COMMENT '门店编码',
    OFFICE_NAME              varchar(200)    NOT NULL    DEFAULT '' COMMENT '门店名称',
    OFFICE_ABBREVIATION               varchar(200)     NOT NULL   DEFAULT '' COMMENT '门店名称缩写',
  ...
  DEFAULT CHARSET = utf8
            ...
            sql = '''
            CREATE TABLE IF NOT EXISTS T01_Office_H_Log
(
    OFFICEID         varchar(50)    NOT NULL    DEFAULT '' COMMENT '门店编码',
    OFFICE_NAME              varchar(200)    NOT NULL    DEFAULT '' COMMENT '门店名称',
    OFFICE_ABBREVIATION               varchar(200)     NOT NULL   DEFAULT '' COMMENT '门店名称缩写',
